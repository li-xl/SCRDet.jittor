...
class ProposalTargetCreator(nn.Module):
    ...
    def execute(self, roi, bbox, bbox_r,label):
        ...
        * :math:`L` is number of object classes possibly including the \
        ...
        gt_roi_loc_r = bbox2loc_r(sample_roi,bbox_r[gt_assignment[keep_index]])

        return sample_roi, gt_roi_loc,gt_roi_loc_r, gt_roi_label
...
class RegionProposalNetwork(nn.Module):
    ...
    def __init__(self, 
        ...
        self.anchor_base = generate_anchor_base(base_size=base_anchor_size,anchor_scales=anchor_scales, ratios=ratios)
